...
describe("pace and consumes", () => {
  ...
  it("prints a future poll estimate but does not claim a past one is scheduled", () => {
    const explicitlyStale = paced(10, { freshness: "stale", fetched_at: "2026-09-03T11:58:00Z" });
    const withInterval = { ...policy, poll_interval_minutes: 5, principal_intervals: { "codex-main": 5 } };
